...
//        GregorianUtil gre = new GregorianUtil(ca);
     ...
     * 用于记录当前处理的时间
     */
    private final Calendar mCurrenCalendar;
    ...
    public String toStrings() {
        ...
        message = getChinaCalendarMsg(lunarYear, lunarMonth, lunarDay);
        if (StringUtil.isNullOrEmpty(message)) {
            ...
            if (!StringUtil.isNullOrEmpty(solarMsg)) {
                ...
                if (!StringUtil.isNullOrEmpty(gremessage)) {
                    ...
                    message = CHINESE_NUMBER[lunarMonth - 1] + "月";
                } else {
                    message = getChinaDayString(lunarDay);
                }
