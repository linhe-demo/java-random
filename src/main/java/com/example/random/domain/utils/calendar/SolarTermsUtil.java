...
public class SolarTermsUtil {
     ...
     * 用于保存24节气
     */
    private static final String[] principleTermNames = {"大寒", "雨水", "春分", "谷雨",
            "小满", "夏至", "大暑", "处暑", "秋分", "霜降", "小雪", "冬至"};
    /**
     * 用于保存24节气
     */
    private static final String[] sectionalTermNames = {"小寒", "立春", "惊蛰", "清明",
    ...
    public void computeChineseFields() {
    ...
    // 大闰月的闰年年份
    private static final int[] bigLeapMonthYears = {6, 14, 19, 25, 33, 36, 38, 41,
